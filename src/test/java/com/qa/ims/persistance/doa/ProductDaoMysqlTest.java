...
//			private CustomerServices customerServices;
	...
	@Spy
	@InjectMocks
	private ProductDaoMysqlTest productDaoMysqlTest;
	static String jdbcurl = "jdbc:mysql://34.105.147.13:3306/";
	static String username = "root";
	static String password = "root";

	public static final Logger LOGGER = Logger.getLogger(ProductDaoMysqlTest.class);
...
//		}
		...
		public static void setup() {
			try {
				...
				statement.executeUpdate("create database ims_test2;");
		...
		public void bCreateTest() {
			ProductDaoMysql productDaoMysql = new ProductDaoMysql("jdbc:mysql://34.105.147.13:3306/", "root", "root");
			String firstName = "Vinesh";
			Double total = 4.3;
			Product product = new Product(firstName, total);
...
//			Customer customer3 = new Customer(first_name3, last_name3);
			product = productDaoMysql.create(product);
