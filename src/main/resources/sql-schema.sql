...
create table if not exists ims.orders(order_id int primary key auto_increment,id int NOT NULL,product_id int NOT NULL,total double, FOREIGN KEY (id) REFERENCES customers (id), FOREIGN KEY (product_id) REFERENCES product (product_id));
