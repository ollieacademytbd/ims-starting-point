...
public class OrderLine {
	...
	public OrderLine(Long order_id, Long orderline_id, Long product_id, Long quantity) {
		super();
	...
	public OrderLine(Long order_id, Long product_id, Long quantity) {
		super();
		this.order_id = order_id;
...
//			this.total = total;
	...
	public String toString() {
		return "Order ID: " + order_id + "Order Line ID: " + orderline_id + "Product ID: " + product_id + " Quantity: "
				+ quantity;
